...
function update_guests()
 ...
 if mouse_pressed() and dragging_guest == nil then
  ...
  if g != nil then
   ...
   -- start dragging from mouse position
   g.x=mouse_x-4
   g.y=mouse_y-4
...
function guest_at_mouse()
 ...
 -- check guests sitting in chairs
 for g in all(guests) do
